...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUIEditor : UnityEditor.Editor
    {
        ...
        protected void OnEnable()
        {
            ...
            m_RebindDupeTextProperty = serializedObject.FindProperty("m_RebindDuplicateText");
            ...
            m_ActionsLocaleProperty = serializedObject.FindProperty("m_LocaleActionLabel");
            m_ActionsLocaleStringProperty = serializedObject.FindProperty("m_LocaleLabelString");
            m_ActionsOverRideProperty = serializedObject.FindProperty("m_OverRideActionLabel");
            m_ActionsOverRideStringProperty = serializedObject.FindProperty("m_ActionLabelString");
        ...
        public override void OnInspectorGUI()
        {
            ...
            using (new EditorGUI.IndentLevelScope())
            {
                ...
                EditorGUILayout.PropertyField(m_RebindDupeTextProperty);
            }
            ...
            using (new EditorGUI.IndentLevelScope())
            {
                EditorGUILayout.PropertyField(m_ActionsLocaleProperty); 
                if (m_RebindActionUI.m_LocaleActionLabel)
                {
                    EditorGUILayout.PropertyField(m_ActionsLocaleStringProperty);
                }
                else
                {
                    EditorGUILayout.PropertyField(m_ActionsOverRideProperty);
                    if (m_RebindActionUI.m_OverRideActionLabel)
                    {
                        EditorGUILayout.PropertyField(m_ActionsOverRideStringProperty);
                    }
                }
            }
        ...
        private SerializedProperty m_RebindDupeTextProperty;
        ...
        private SerializedProperty m_ActionsLocaleProperty;
        private SerializedProperty m_ActionsLocaleStringProperty;
        private SerializedProperty m_ActionsOverRideProperty;
        private SerializedProperty m_ActionsOverRideStringProperty;
